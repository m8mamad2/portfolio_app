...
export const WobbleCard = ({
  ...
  return (
    ...
    >
      <div
        className="relative  py-10 sm:py-0 h-full [background-image:radial-gradient(88%_100%_at_top,rgba(255,255,255,0.5),rgba(255,255,255,0))]  sm:mx-0 sm:rounded-2xl overflow-hidden"
        style={{
          boxShadow:
      ...
      >
        <motion.div
          ...
          className={cn("h-full px-4 sm:px-10", className)}
        >
          <Noise />
          {children}
        </motion.div>
